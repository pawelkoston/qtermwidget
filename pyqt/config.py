...
sip_command = " ".join([config.sip_bin, '-I', str(config.pyQtIncludePath), str(
    config.pyqt_sip_flags), "-b", build_file, "-o", "-c", ". " " qtermwidget.sip"])
print(sip_command)
print(config.pyqt_sip_flags)
#/usr/bin/sip -I /usr/share/sip/PyQt5 -t WS_X11 -t Qt_5_11_2 -b qtermwidget.sbf -o -c .  qtermwidget.sip
